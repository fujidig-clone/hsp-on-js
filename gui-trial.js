...
with(HSPonJS) {
	BuiltinFuncs[Token.Type.EXTCMD][0x18] = function color(r, g, b) {
		this.scanArgs(arguments, 'NNN');
		r = r ? r.toIntValue()._value : 0;
		g = g ? g.toIntValue()._value : 0;
		b = b ? b.toIntValue()._value : 0;
		this.ctx.fillStyle = Color.toRGBString(r, g, b);
	};
	BuiltinFuncs[Token.Type.EXTCMD][0x31] = function boxf(x1, y1, x2, y2) {
